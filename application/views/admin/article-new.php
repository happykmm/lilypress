...
<head>
   ...
   <link href="<?php echo base_url('public/css/admin-article-new.css') ?>" rel="stylesheet">
   <script src="<?php echo base_url('public/js/admin-article-new.js') ?>"></script>
         ...
         <div class="col-xs-2 sidebar">
            <ul class="nav nav-sidebar">
               ...
               <li><a class="active" href="<?php echo base_url('index.php/admin/article/list/1') ?>">
                  ...
                  <a class="hidden-xs" id="btnArtList" href="<?php echo base_url('index.php/admin/article/list/1') ?>">所有文章</a>
                  <a class="hidden-xs" id="btnNewArt" href="<?php echo base_url('index.php/admin/article/new') ?>"><strong>新建文章</strong></a>
